...
| <a id="rastrear">**L - Receber**</a> | Verbo | O usuário pode receber uma encomenda em um endereço residencial, comercial, locker, caixa postal ou agência dos Correios. | O recebimento da encomenda pelo usuário finaliza o processo de entrega realizado pelos Correios | Obter, Adquirir |[Gabriel Basto](https://github.com/Bertolazi) |
