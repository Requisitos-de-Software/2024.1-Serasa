...
| <a id="usuario">**L10 - Usuário**</a> | Objeto | O usuário é normalmente definido como uma entidade ou objeto. Podendo ser alguém que queira realizar um <a href="#enviar">envio</a>, <a href="#rastrear">rastreio</a>, <a href="#simular">simulação</a> etc.  | O usuário pode realizar diversas tarefas dentro do app,   | Cliente, utilizador e consumidor |[Claudio Henrique](https://github.com/claudiohsc) |
