...
| **US20** | Acessar Contatos das Empresas | Como um usuário, quero acessar contatos das empresas, para resolver questões específicas. | Informações de contato das empresas disponíveis e atualizadas | Baixa | RF08 | [EP12][epicos] |
