...
<span> Fernando </span>- Que o app possua a função de rastreio de encomendas e a parte de simulação de envio com as informações do pacote, como peso, dimensões e CEP.
...
| `1.4`  | 23/06/2024 | Mudança na disposição das tabelas | [Elias F. Oliveira](https://github.com/EliasOliver21) e [Claudio Henrique](https://github.com/claudiohsc)| [](https://github.com/) |
